...
import views.ChinhSuaPanel;
import views.HomePagePanel;
import views.ThemMoiPanel;
...
public class MainController {
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) {
        ...
        switch (kind) {
            case "TrangChu":
                ...
                break;
            case "ChinhSua":
                view = new ChinhSuaPanel(this.jfrMain);
                break;
            case "TimKiem":
            ...
            case "ThongKe":
                ...
                break;
            case "ThemMoi":
                view = new ThemMoiPanel(this.jfrMain);
                break;
            //any more
            default:
                break;
    ...
    public void setEvent(List<DanhMucBean> listDanhMuc) {
        ...
        this.listDanhMuc.forEach((item) -> {
            item.getJlb().addMouseListener(new LabelEvent(this.jfrMain,
                    item.getKind(), item.getJpn(), item.getJlb()));
        });
    }
